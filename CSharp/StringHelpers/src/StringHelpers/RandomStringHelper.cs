...
{
    private const string AlphabetLower = "abcdefghijklmnopqrstovwxyz";
    ...
    private static string InternalGenerateString(char[] characterSet, int length)
    {
        ...
        try
        {
            ...
            return string.Create(
                length: length,
                state: new StringCreateArgs(AvailableCharacters: characterSet, RandomStringBytes: randomStringBytes, Length: length, Multiplier: multiplier),
